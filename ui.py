...
# 1.                            UI CONFIGURATION
# =============================================================================
from ui_parts.ui_commons import (
    APP_NAME,
    APP_VERSION,
...
# 3.                          FONT LOADING
# =============================================================================
from ui_parts.ui_commons import find_project_root, load_fonts
...
# 4.                          ICON UTILITIES
# =============================================================================
from ui_parts.ui_commons import get_icon


# =============================================================================
# 5.                          UTILITY HELPERS
# =============================================================================
from ui_parts.ui_commons import normalize_path

from ui_parts.force_models_page import find_best_gravity_file
from ui_parts.command_builder import build_command, build_command_preview, build_preflight_snapshot, build_mc_command
from ui_parts.preflight_validation import PreFlightWorker
...
# =============================================================================
from ui_parts.mission_propagation_page import UISolverConfig, UISpacecraftConfig
...
# =============================================================================
from ui_parts.ui_commons import StatusBadge
...
# =============================================================================
from ui_parts.mission_propagation_page import SolverSettingsDialog
...
# =============================================================================
from ui_parts.mission_propagation_page import SpacecraftBusDialog
...
# =============================================================================
from ui_parts.force_models_page import UIAlbedoConfig
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _build_page_orbit(self) -> QtWidgets.QWidget:
        ...
        """
        from ui_parts.orbit_config_page import OrbitPage  # local import to avoid circulars
    ...
    def _build_page_forces(self) -> QtWidgets.QWidget:
        ...
        """
        from ui_parts.force_models_page import ForceModelsPage  # local import to avoid circulars
    ...
    def _build_page_propagation(self) -> QtWidgets.QWidget:
        from ui_parts.mission_propagation_page import MissionPropagationPage
    ...
    def _build_page_telemetry(self) -> QtWidgets.QWidget:
        from ui_parts.live_telemetry_page import TelemetryPage
    ...
    def _build_page_data(self) -> QtWidgets.QWidget:
        from ui_parts.data_files_page import DataPage, DataFilesState
    ...
    def _build_page_mc(self) -> QtWidgets.QWidget:
        ...
        from ui_parts.monte_carlo_page import MonteCarloPage
