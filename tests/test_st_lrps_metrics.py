...
import surrogate_gravity_model.st_lrps_metrics as metrics_mod
from surrogate_gravity_model.st_lrps_metrics import (
    LOWER_IS_BETTER,
...
def test_publication_eval_suite_outputs_summary_files(tmp_path):
    from surrogate_gravity_model.st_lrps_evaluate import _write_publication_eval_suite
