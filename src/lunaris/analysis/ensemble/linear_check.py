...
Validates the ensemble sample covariance against linear covariance propagation
``P(t) = Φ(t) P₀ Φ(t)ᵀ`` in the small-dispersion regime, where the two must
agree up to sampling/design error. The state-transition matrices are built by
