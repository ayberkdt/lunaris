...
batch-propagated :class:`~lunaris.common.batch_defs.MCRunResult` ensemble into
...
def _write_figures(
    ...
    for name, build in builders:
        try:
            ...
            return written, f"matplotlib unavailable: {exc}"
        try:
...
def main(argv: list[str] | None = None) -> int:
    """Post-hoc UQ report over an existing batch-propagated ensemble archive."""
