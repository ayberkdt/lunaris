...
plot_ric_sigma_history
    RIC-frame 1-σ position uncertainty growth vs time.

plot_covariance_eigenvalues
    Position-covariance principal 1-σ lengths vs time.
...
plot_mc_report
    Backward-compatible master function: all ensemble plots on a single
    multi-page PDF.
...
def plot_altitude_envelope(
    ...
    *,
    ...
    figsize: tuple[float, float] | None = None,
    title: str = "Altitude Envelope - Propagated Ensemble",
) -> Any:
    """
