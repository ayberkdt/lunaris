"""Typed design tokens for the Lunaris desktop interfaces."""
...
class ColorTokens:
    ...
    bg_shell: str = "#0C121B"
    bg_card: str = "#121A25"
    bg_card_alt: str = "#192433"
    bg_inset: str = "#0D151F"
    bg_entry: str = "#0A121C"
    bg_log: str = "#05080D"
    bg_hover: str = "#1D2A3A"
    bg_overlay: str = "rgba(3,6,11,0.88)"

    fg_main: str = "#F3F6FB"
    fg_soft: str = "#C5D0DE"
    fg_muted: str = "#94A3B8"
    fg_disabled: str = "#728298"
    fg_inverse: str = "#07111F"
    fg_link: str = "#8AB8FF"

    accent: str = "#4F8CFF"
    accent_hov: str = "#77A8FF"
    accent_dim: str = "rgba(79,140,255,0.14)"
    accent_deep: str = "#6687B1"
    secondary: str = "#22D3B6"
    secondary_hov: str = "#5EEAD4"
    secondary_dim: str = "rgba(34,211,182,0.12)"
    ...
    border: str = "#465A73"
    border_soft: str = "#253246"
    border_strong: str = "#60758F"
...
class VisualizationTokens:
    ...
    sun: str = "#FACC15"
    earth: str = "#60A5FA"
    selected_plot: str = "#4F8CFF"
    comparison_plot: str = "#22D3B6"
