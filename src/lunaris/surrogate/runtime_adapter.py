...
The adapter belongs to the surrogate subsystem because it knows both the
ST-LRPS artifact/runtime contract and the engine gravity-provider protocol.
The engine and physics layers consume this narrow adapter without importing
the ML data, training, evaluation, or UI pipelines.
