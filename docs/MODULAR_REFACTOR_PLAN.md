...
3. Preserve existing import paths via compatibility shims only when explicitly
   retained as public API; obsolete analysis aliases may be removed in a hard
   namespace cut.
