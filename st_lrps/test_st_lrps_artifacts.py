...
from surrogate_gravity_model.st_lrps_artifacts import (
...
from surrogate_gravity_model.st_lrps_evaluate import evaluate, predict_residual_u_a
...
def test_evaluator_and_force_model_use_same_artifact_loader(canonical_run: dict) -> None:
    ...
    from surrogate_gravity_model.st_lrps_artifacts import reload_model_from_run_dir
