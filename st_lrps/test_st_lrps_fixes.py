...
from st_lrps.st_lrps_force_model import SurrogateForceModel, ScalerPack
from st_lrps.spatial_cloud_generator import _run_active_refinement, _sh_potential_accel_batch_serial
from st_lrps.st_lrps_engine import TrainConfig
...
from st_lrps.st_lrps_scaling import ScalerPack, IsometricScaleParams
...
def test_sh_inspired_angular_encoding_in_all():
    ...
    import st_lrps.st_lrps_models as _m
...
def test_active_refinement_uses_mu_si_and_r_ref_m_keys(tmp_path, monkeypatch):
    ...
    def fake_load_icgem_gfc(file_path, max_degree, **kw):
        ...
        from st_lrps.dataset_parameters import MU_MOON_SI, R_MOON_SI
        gmeta = {
            "mu_si": MU_MOON_SI,
            "r_ref_m": R_MOON_SI,
            "degree": max_degree,
    ...
    from st_lrps.dataset_parameters import R_MOON_SI
    r0 = R_MOON_SI + 300e3
...
def _make_small_h5(path: Path, n: int = 150):
    ...
    from st_lrps.dataset_parameters import R_MOON_SI, MU_MOON_SI
