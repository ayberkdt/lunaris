...
-----
Preferred:
    from models import GravityModel, ThirdBodyModel

If you need the full submodule (advanced / bulk access):
    from models import spherical_harmonics   # lazy module
    from models import surface_effects       # lazy module
"""
...
# Exposed so users can do `from models import surface_effects` without eager import.
# -----------------------------------------------------------------------------
