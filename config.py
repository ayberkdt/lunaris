...
if TYPE_CHECKING:
    ...
    from models.solar_effects import SRPConfig
    from models.surface_effects import AlbedoConfig, ThermalConfig
    from models.third_body_effects import EarthJ2Params
...
# Anchor paths relative to this file (repo root is expected to contain: common/, models/, core/, data/)
...
def load_default_config() -> SimConfig:
    ...
    try:
        ...
        raise ImportError(
            "Failed to import models.ephemeris (requires 'spiceypy' and 'numba' to be installed and compatible)."
        ) from e
